$(document).ready(function() {
  ...
  $.getJSON('../kq01/d/movies.json', function(data) {
    var keywords = data[0];
    ...
    function displayContent(keyword) {
      ...
      if (videoPath) {
        $('#videoContainer').html('<div class="vid"><iframe id="vii" src="' + videoPath + '" controls controlsList="nodownload" frameborder="0" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true"></iframe></div><button class="back"> Kembali</button>');
        $('#inputans').hide();
